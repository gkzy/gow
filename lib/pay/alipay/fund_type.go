...
// AliPayFundTransToAccountTransfer 单笔转账到支付宝账户接口请求结构
...
// AliPayFundTransOrderQuery https://docs.open.alipay.com/api_28/alipay.fund.trans.order.query/
// 查询转账订单接口请求参数
...
// AliPayFundTransOrderQueryResponse 查询转账订单接口响应参数
...
//AliPayFundAuthOrderAppFreezeResponse AliPayFundAuthOrderAppFreezeResponse
